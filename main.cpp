...
//
//    aes128.encrypt(plaintext, 16, aes128keyExpansionCipherKey);


//    AesEncryptObj aes192(192);
//
//    aes.encrypt(plaintext, 16, aes192keyExpansionCipherKey);


    AesEncryptObj aes256(256);
    aes256.encrypt(plaintext, 16, aes256keyExpansionCipherKey);
